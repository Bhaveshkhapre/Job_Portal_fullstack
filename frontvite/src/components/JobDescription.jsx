...
import { APPLICATION_API, JOB_API } from '@/api/auth';
    ...
    return (
        <div>
            ...
            <div className='max-w-7xl mx-auto my-10'>
                ...
                <h1 className='font-bold text-lg mt-10 mb-2 border-b-2 border-gray-300'>Job Description</h1>
                <div className='my-4'>
                    ...
                    <h1 className="font-bold my-2 flex items-start gap-3">
                        <span className="min-w-[120px]">Skills Required:</span>
                        ...
                        <span className="flex flex-wrap gap-2">
                            {singleJob?.requirements?.map((skill, index) => (
                                <Badge
                                    key={index}
                                    variant="outline"
                                    className="text-blue-700 font-medium px-3 py-1 rounded-full"
                                >
                                    {skill}
                                </Badge>
                            ))}
